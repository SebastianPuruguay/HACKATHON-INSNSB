...
export function About() {
  return (
    <section id="acerca" className="section-glow relative overflow-hidden border-y border-white/[0.04] bg-slate-950 py-24 sm:py-32">
      ...
      <div className="section-shell relative grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:gap-20">
        ...
        <Reveal delay={0.12}>
          <div className="overflow-hidden rounded-[36px] border border-white/10 bg-slate-900/70 p-3 shadow-[0_24px_80px_rgba(0,0,0,0.35)] backdrop-blur-xl">
            ...
            <div className="soft-grid mt-3 grid rounded-[28px] border border-white/[0.06] bg-gradient-to-br from-slate-900 to-indigo-950/60 p-5 sm:grid-cols-2 sm:p-6">
              {details.map((detail) => {
                ...
                return (
                  ...
                  >
                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl border border-white/10 bg-white/[0.06] text-indigo-300 shadow-sm">
