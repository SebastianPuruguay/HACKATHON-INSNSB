...
export function RegistrationCTA() {
  return (
    <section id="registro" className="py-24 sm:py-32">
      <div className="section-shell">
        <Reveal>
          <div className="relative overflow-hidden rounded-[40px] bg-gradient-to-br from-[#080d2b] via-[#25206e] to-[#641b9c] px-7 py-14 text-white shadow-[0_30px_100px_rgba(79,70,229,0.28)] sm:px-12 sm:py-16 lg:px-20 lg:py-20">
