...
export function FAQ() {
  ...
  return (
    <section className="section-glow relative overflow-hidden border-y border-white/[0.06] bg-[#0b0c3b] py-24 sm:py-32">
      ...
      <div className="section-shell relative z-10 grid gap-12 lg:grid-cols-[0.75fr_1.25fr] lg:gap-20">
        ...
        <Reveal delay={0.1} className="space-y-3">
          {questions.map((item, index) => {
            ...
            return (
              <div key={item.question} className="overflow-hidden rounded-3xl border border-white/10 bg-[#230443]/55 shadow-[0_15px_45px_rgba(0,0,0,0.22)] backdrop-blur-xl">
                <button type="button" onClick={() => setOpenIndex(isOpen ? null : index)} className="flex w-full items-center justify-between gap-5 p-5 text-left sm:p-6" aria-expanded={isOpen}>
                  ...
                  <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full border border-[#f58220]/25 bg-[#ec008c]/10 text-[#f58220]">
